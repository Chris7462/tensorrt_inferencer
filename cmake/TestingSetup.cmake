...
add_custom_command(
  OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/fcn_resnet50_374x1238.engine
  COMMAND ${CMAKE_COMMAND} -E create_symlink
          ${CMAKE_CURRENT_SOURCE_DIR}/engines/fcn_resnet50_374x1238.engine
          ${CMAKE_CURRENT_BINARY_DIR}/fcn_resnet50_374x1238.engine
...
add_custom_target(test_engine_link
  DEPENDS ${CMAKE_CURRENT_BINARY_DIR}/fcn_resnet50_374x1238.engine
)
...
add_custom_command(
  ...
  DEPENDS ${CMAKE_CURRENT_SOURCE_DIR}/test/image_000.png
